 ...
 *
 */
$drupal_hash_salt = '9EXpAVVypCLCLYSxXzrrCmFCpgzzNhK9qYT6st6y87g';
...
if (file_exists('../../settings/settings.local.nyctt.php')) {
  require '../../settings/settings.local.nyctt.php';
} else {
  require 'sites/default/settings.amazon.php';
}
